...
h2 = plot(1:T,x,'b','LineWidth',3);
h3 = plot(1:T,xh,'r','LineWidth',3);
...
legend([h2 h3],'Actual state','Mean estimated state');
title('State estimation using particle filter','FontSize',14);
set(findobj('type','axes'),'fontsize',20)
%% plot of the observation vs filtered observation by the particle filter
figure
plot(1:T,y,'b', 1:T,yh,'r', 'LineWidth',3);
